...
const translations = {
    cs: {
        ...
        helpLines: [
            ...
            'Myš — Rozhlížení',
            'SPACE — Útok / použití zbraně',
            '1 — Krumpáč  2 — Válečný krumpáč',
            '3 — Kuše (SPACE střílí, spotřebovává šipky)',
            '4 — Dynamit (SPACE přidržet = větší dosah, pustit = hodit)',
            'F — Otevřít dveře (zamčené vyžadují klíč)',
            'SPACE u dřevěné zdi — Prolomit (3 rány krumpáčem)',
        ...
        edGenTargetScore: 'Cílové skóre:',
        edGenEstScore:  'odhadované skóre',
        edGenSize:      'Velikost:',
        ...
        tWarhammer:    'Válečný krumpáč',
        tCrossbow:     'Kuše',
        tAmmoBolt:     'Šipky do kuše',
        tAmmoDynamite: 'Dynamit',
        ...
        tDescMineCart:    'Důlní vozík — dekorace, blokuje pohyb',
         ...
         tDescWarhammer:   'Válečný krumpáč — 2× síla, pomalejší útok',
         tDescCrossbow:    'Kuše — vzdálený útok s municí',
         tDescAmmoBolt:    'Munice do kuše',
         tDescAmmoDynamite:'Dynamit — vhazuje se a exploduje',
    ...
    en: {
        ...
        helpLines: [
            ...
            'Mouse — Look around',
            'SPACE — Attack / use weapon',
            '1 — Pickaxe  2 — Warhammer',
            '3 — Crossbow (SPACE fires, uses bolts)',
            '4 — Dynamite (hold SPACE = longer throw, release = throw)',
        ...
        edGenRooms:     'Rooms:',
        edGenTargetScore: 'Target Score:',
        edGenEstScore:  'estimated score',
        edGenSize:      'Size:',
        ...
        tWarhammer:    'Warhammer',
        tCrossbow:     'Crossbow',
        tAmmoBolt:     'Crossbow Bolts',
        tAmmoDynamite: 'Dynamite',
        ...
        tDescMineCart:    'Mine cart — decoration, blocks movement',
         ...
         tDescWarhammer:   'Warhammer — 2× power, slower attack',
         tDescCrossbow:    'Crossbow — ranged attack with ammo',
         tDescAmmoBolt:    'Crossbow ammo',
         tDescAmmoDynamite:'Dynamite — throw and explode',
